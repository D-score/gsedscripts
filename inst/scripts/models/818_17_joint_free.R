...
# Estimates 818_17 model on joint data, free estimates
# Conclusion: This solution is not properly standardised and goes off the plot.
# 20220601 SvB
...
# fit
model_name <- paste(length(items), length(equatelist), "joint", "free", sep = "_")
model <- fit_dmodel(varlist = varlist,
                    data, equate = equatelist, b_fixed = NULL,
