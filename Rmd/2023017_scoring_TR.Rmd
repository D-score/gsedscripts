...
The required input consists of *item level* responses on milestones collected using instruments for measuring child development, including the GSED LF and GSED SF.
...
:------------------|:--------------- |--------------:|:----------------
`GSED SF`          | `gs1`           | 139           | Active
`GSED LF`          | `gl1`           | 155           | Active
